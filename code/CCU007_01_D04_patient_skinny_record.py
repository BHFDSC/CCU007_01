...
# MAGIC
# MAGIC **Data output** `.ccu007_01_nicor_patient_imd_ak_221010`
# MAGIC
...
# MAGIC %run Workspaces//CCU007_01/CCU007_01-functions/wrang000_functions
...
# MAGIC SELECT *
# MAGIC FROM .nicor_congenital_ as nicor
...
# MAGIC LEFT JOIN (SELECT DISTINCT lsoa_code, region_name FROM .curr901a_lsoa_region_lookup) as lsoa_reg ON lsoa_reg.lsoa_code=pat.LSOA;
