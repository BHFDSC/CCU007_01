...
# MAGIC
# MAGIC  
# MAGIC **Data input**  `.deaths__archive`; 
# MAGIC
# MAGIC **Data output** `.ccu007_01_nicor_death_master_ak_221010`
# MAGIC
...
def create_table(table_name:str, database_name:str='', select_sql_script:str=None, if_not_exists=True) -> None:
